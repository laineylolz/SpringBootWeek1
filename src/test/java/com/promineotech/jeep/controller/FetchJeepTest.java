...
class FetchJeepTest{
	...
	void testThatAnErrorMessageIsReturnedWhenAnInvalidValueIsSupplied(String model, 
	...
	static Stream<Arguments> parametersForInvalidInput() {
		...
		return Stream.of(
				...
				arguments("WRANGLER", "C".repeat(Constants.TRIM_MAX_LENGTH + 1), "Trim Legnth Too Long"),
	...
	@Sql(scripts = {"classpath:flyway/migrations/V1.0__Jeep_Schema.sql",
			"classpath:flyway/migrations/V1.1__Jeep_Data.sql"},
	config = @SqlConfig(encoding = "utf-8"))
	class TestsThatPollutesTheApplicationContext extends FetchJeepTestSupport{
		...
		void testThatAnUnplannedErrorResultsInA500Status() {
		  ...
		  // Then: an internal sever error (500) status is returned
